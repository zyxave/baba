...
/**
 * APAC 2015 Round A Problem C: Addition
        ...
        while (q-->0) {
            ...
            if (varibles[fu].val!=1e9
                ...
                if (varibles[fu].val==1e9
                        || varibles[fv].val==1e9)
                    continue;
                ans.add(ss[0] + " " + ss[1] +" "+(int)((varibles[u].constant+varibles[u].flag*varibles[fu].val
                        +varibles[v].constant+varibles[v].flag*varibles[fv].val)));
            }
            else {
                if (fu!=fv) continue;
                if (varibles[u].flag==varibles[v].flag) continue;
                ans.add(ss[0] + " " + ss[1] +" "+(varibles[u].constant+varibles[v].constant));
            }
        }
        return String.join("\n", ans);
    }
