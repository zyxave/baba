...
begin
      ...
      for tc:=1 to n do begin 
            ...
            if (max=length(s)) then writeln('YES')
            else if (sapi[max]=sapi[min]) then writeln('YES')
            else if (((sapi[min]=1) and (min=1))) then writeln('YES')
            else if ((sapi[max]<sapi[min]) and ((max-min)=abs(1)) and (sapi[max]=1)) then writeln('YES')
            else writeln('NO');
