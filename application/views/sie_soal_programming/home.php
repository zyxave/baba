...
<div class="row">
    <div class="col-xs-6 col-sm-3 col-md-2">
        <a href="<?php echo base_url() . 'admin/programming/new_contest'?>" class="btn btn-ilpc"><i class="fa fa-plus"></i> New Contest</a>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="progtbl">
            <div class="tbl-hdr">Nama Kontes : <a href="<?php echo base_url(). 'admin/programming/contest/' . $contest['id']; ?>"><?php echo $contest['nama']; ?></a> Created By <?php echo $contest['creator'];?></div>
            <div class="row no-gutter">
                ...
                <div class="col-xs-12 col-sm-3 col-md-1">
                    <a href="<?php echo base_url(). 'admin/programming/scoreboard/' . $contest['id']; ?>" class="btn btn-ilpc">Scoreboard</a>
                </div>
            </div>
