...
<div class="row panduan-utama">
    <div class="container">
        <h1 class="text-center">Panduan ILPC 2018</h1>   
        <div class="col-lg-1"></div>
            <div class="col-lg-10 col-md-12">
                <p class="updated">Last Update: 03 Oktober 2017 00.00 WIB</p>
                <p>Soal ILPC 2018 terdiri dua (2) jenis, yaitu soal logika dan soal pemrograman. Khusus pada babak penyisihan, soal logika berbentuk soal pilihan ganda sebanyak 40 soal. Sedangkan pada babak semifinal dan final, soal logika berbentuk isian dan essay. Soal pemrograman sebanyak 8 soal dan memiliki bentuk yang sama baik pada babak penyisihan, semifinal, maupun final.</p>
            </div>
        <div class="col-lg-1"></div>
    </div>
</div>

<div class="row panduan-logika">
    <div class="container">
        <div class="col-xs-12">
            <h2>Soal Logika</h2>
            <div class="soal-logika">
                <h3>Contoh Soal</h3>
                <div>
                    ...
                    <ol type="a">
                        ...
                        <li><b>Adi sedang bermain</b>&nbsp;<i class="fa fa-check"></i></li>
                        <li>Listrik mati</li>
                ...
                <div>
                    ...
                    <ol type="a">
                        ...
                        <li>10/36</li>
                        <li>13/36</li>
                        <li><b>12/36</b>&nbsp;<i class="fa fa-check"></i></li>
                        <li>24/36</li>
                    </ol>
                </div>
            </div>
...
<div class="row panduan-programming">
    <div class="container">
        <div class="col-xs-12">
            <h2>Soal Pemrograman</h2>
            <div class="deskripsi-programming">
        ...
        <div class="col-xs-12 struktur-programming">
            ...
            <ol>
                ...
                <li><span class="penting">Format Input dan Output</span>
                    <p><span class="penting">Format Input</span> merupakan deskripsi bagaimana inputan akan diberikan juri kepada program peserta saat dijalankan. Sedangkan <span class="penting">Format Output</span> adalah bagaimana seharusnya output jawaban peserta ditampilkan. Apabila peserta tidak mengikuti format input dan output, jawaban peserta dinilai salah <strong>(Wrong Answer)</strong>
                    </p>
                <p class="penting term-cond">* Peserta tidak perlu mengecek validitas inputan, karena inputan yang diberikan juri pasti sesuai dengan kriteria yang tertera pada soal.</p>
                </li>
        ...
        <div class="soal-programming">
            <h3>Contoh Soal</h3>
            <a class="btn btn-default" role="button" data-toggle="collapse" href="#contohSoal">Show / Hide Soal</a>
            ...
            </div> <!-- end of collapse contoh soal -->
            ...
            <a class="btn btn-default" role="button" data-toggle="collapse" href="#jawabanBenar">Show / Hide Soal</a>
            <pre id="jawabanBenar" class="source-code collapse"><code class="language-java">import java.util.Scanner;
...
class Main {
    public static void main(String[] args) {
        ...
        for(int tc=1; tc<= t; tc++)  {
            ...
            <a class="btn btn-default" role="button" data-toggle="collapse" href="#jawabanSalah">Show / Hide Soal</a>
            <pre id="jawabanSalah" class="source-code collapse"><code class="language-java">import java.util.Scanner;
...
class Main {
    public static void main(String[] args) {
        ...
        </div><!-- end of soal programming -->
    </div><!-- end of container -->
</div><!-- end of panduan programming -->

<div class="row compiler-ilpc">
    <div class="container">
        <div class="col-xs-12">
            <h2>Program</h2>
            <p class="updated">Last Update: 14 Oktober 2017 22.51 WIB</p>
            <p>Berikut adalah program-program yang akan kami pakai dalam ILPC 2018:</p>
            <p></p>
            <div class="isi-compiler">
                <h3>Compiler</h3>
...
<div class="row penilaian-ilpc">
    <div class="container">
        <div class="col-xs-12">
            <h2>Penilaian</h2>
            <p class="updated">Last Update: 14 Oktober 2017 22.51 WIB</p>
            <p>Untuk memahami bagaimana juri melakukan penilaian beserta tips untuk menghindari error, silahkan <a href="https://docs.google.com/uc?export=download&id=1H5nSOCzBVSmYvG38S-H_56XBm2Ha5-qB" target="_blank">Download Petunjuk Penilaian</a></p>
        </div>
    </div>
</div>

</div>
<script src="<?php echo base_url('asset/2017/js/prism.js'); ?>"></script>