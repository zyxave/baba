        ...
        <div class="adminTopNav">
            ...
            <div class="row">
                <div class="col-xs-4 col-sm-2">
                    <a href="<?php echo base_url() ?>admin/registration/ready_team/<?php echo $backPage; ?>" class="btn btn-ilpc"><span class="fa fa-arrow-left fa-lg"></span> Back </a>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-xs-12">
        <?php if(isset($_SESSION['addReserveSucceed'])):?>
            <div class="row">
                <div class="col-xs-12">
                    <div class="success-box"> Anggota cadangan telah berhasil ditambahkan</div>
                </div>
            </div>
        <?php endif; ?>
        <div class="r-box">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <?php if($tim['status'] == 'ready') : ?>
                        <div>Status Pembayaran : Telah diterima panitia</div>
                        <div>Status Tim : siap mengikuti ILPC</div>
                    <?php endif; ?>
                    <div class="row">
                        <div class="col-xs-12">
                ...
                <?php $jmlhAnggota = count($anggota);
                if($jmlhAnggota < 4) :?>
                <div class="row"><div class="col-xs-12 col-sm-4"><br><a class="btn btn-ilpc" href="<?php echo base_url() . 'admin/registration/add_reserve_member/' . $tim['id']; ?>"><i class="fa fa-plus"></i> Anggota Cadangan</a></div></div>
            <?php endif; ?>
            <div class="row">
                <?php
                $x = 1;
                    ...
                    <div class = "i-box member-box">
                        <div class="pic-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-9"><?php echo $row['ukuran_baju'] == 'REGULAR' ? 'REGULAR' : 'BIG' ?>
                                </div>
                            </div>
                        </div>
                    </div>
