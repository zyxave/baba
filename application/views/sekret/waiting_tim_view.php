...
<div class="row">
    <div class="col-xs-12 col-lg-10">
        <h1>Tim Yang Belum Mengupload Bukti Transfer</h1>
        <div class="row">
            ...
            <?php if(isset($searchKeyword)) : ?>
                ...
                <div class="col-xs-6 col-sm-2">
                    <form method="get" action="<?php echo base_url(); ?>admin/registration/reset_search_waiting">
        ...
        <div class="row">
            <form action="<?php echo site_url('admin/registration/waiting_team_list'); ?>" method="post">
                <p>
                    <div class="col-xs-12 col-sm-3"><input type="search" name="cari" placeholder="Search Keyword..." class="form-control"></div>
        ...
        <div class="row">
        <?php if(count($listwaitingtim) > 0) :
            foreach ($listwaitingtim as $row) {
                ?>
                <div class="col-xs-12">
                    <div class="databox">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2">
                                <a href="<?php echo base_url() . "admin/registration/waiting_team_list_detail/" . $row['id'] ?>" class="btn btn-ilpc">Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
