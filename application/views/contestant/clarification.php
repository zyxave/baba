<div class="container">
<div class="row jenis-kontes">
    <div class="col-sm-12">
        <h1 class="judul-contest"><?php echo $_SESSION['nama_kontes'];?></h1>
		<div class="col-sm-offset-3 col-sm-6">
		<?php if($_SESSION['tipe_kontes'] === 'programming') : ?>
            <p style="text-align:center;"> Selamat datang dalam kontes programming. Catatan kecil tentang apa yang bisa dilakukan user di halaman tersebut, bagaimana caranya, bagaimana format klarifikasi yang benar serta output apa yang bakal diterima user. </p>
        <?php elseif($_SESSION['tipe_kontes'] === 'multiple_choice') : ?>
            <p style="text-align:center;"> Selamat datang dalam kontes logika. catatan kecil tentang apa yang bisa dilakukan user di halaman tersebut, bagaimana caranya, bagaimana format klarifikasi yang benar serta output apa yang bakal diterima user. </p>
        <?php endif; ?>
		</div>
